        ...
        <div class="w-full max-w-md mx-auto my-5 p-8 rounded-2xl bg-white/90 backdrop-blur shadow-2xl">
            ...
            <form @submit.prevent="authStore.authentication('register', formData)" class="space-y-5">
                <BaseInput
                    ...
                    placeholder="Name"
                    :error="authStore.registerErrors?.name?.[0]"
                />
                <BaseInput
                    type="email"
                    label="Email"
                    ...
                    :error="authStore.registerErrors?.email?.[0]"
                />
                <div class="relative">
                    <BaseInput
                ...
                <div class="relative">
                    <BaseInput
                        ...
                        placeholder="••••••••"
                        :error="authStore.registerErrors?.password_confirmation?.[0]"
                    />
